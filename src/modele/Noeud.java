...
public class Noeud implements Comparable<Noeud> {
	 ...
	 *            l'id du noeud
	 * @param x
	 *            la position géographique en x du noeud
	 * @param y
	 *            la position géographique en y du noeud
	 */
	 ...
	 *            la position géographique en y du noeud
	 * @param troncons
	 *            les troncons sortants du noeud
	 */
	 ...
	 *            le nouveau <code>Troncon</code> à ajouter au <code>Set</code>
	 *            de <code>Troncon</code>
	 */
